...
![A screenshot of the app we are going to build, showing how we can substitute the background of a subject with a computer-generated one described through text](https://video.udacity-data.com/topher/2023/December/6586165d_screen/screen.jpg)
...
![An image of a cat is shown, with green points marking input points for the Segment Anything Model (SAM). SAM returns a segmentation mask, then through a text prompt the cat is removed and an crocodile is put in its place.](https://video.udacity-data.com/topher/2023/December/658613c9_screen/screen.jpg)
